...
## eosio.system::unstake        account quantity 
   ...
   - all producers this 'account' has voted for will have their votes updated immediately.

   - bandwidth and storage for the deferred transaction will be billed to 'account'
