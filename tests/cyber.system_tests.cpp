...
BOOST_AUTO_TEST_SUITE(cyber_system_tests)

BOOST_FIXTURE_TEST_CASE( buysell, cyber_system_tester ) try {

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   transfer(config::system_account_name, "alice1111111", core_sym::from_string("1000.0000"));
   BOOST_REQUIRE_EQUAL(success(), stake(config::system_account_name, "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000")));
   ...
   BOOST_REQUIRE_EQUAL(initial_ram_balance + core_sym::from_string("199.0000"), get_balance(config::ram_account_name));
   BOOST_REQUIRE_EQUAL(initial_ramfee_balance + core_sym::from_string("1.0000"), get_balance(config::ramfee_account_name));
   ...
   transfer(config::system_account_name, "alice1111111", core_sym::from_string("100000000.0000"));
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, cyber_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( init_eosio_stake_balance + core_sym::from_string("300.0000"), get_balance(config::stake_account_name) );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, cyber_system_tester ) try {
   cross_15_percent_threshold();

   issue(config::system_account_name, core_sym::from_string("1000.0000"), config::system_account_name);
   issue(config::stake_account_name, core_sym::from_string("1000.0000"), config::system_account_name);
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   //system stakes for alice with transfer flag

   transfer(config::system_account_name, "bob111111111", core_sym::from_string("1000.0000"));
   ...
   transfer(config::system_account_name, "alice1111111", core_sym::from_string("1000.0000"));
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   //now alice's stake should be equal to transfered from cyber + own stake
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( core_sym::from_string("700.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_while_pending_refund, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, cyber_system_tester ) try {
   cross_15_percent_threshold();

   issue( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL(success(), stake(config::system_account_name, "alice1111111", core_sym::from_string("2000.0000"), core_sym::from_string("1000.0000")));
...
BOOST_FIXTURE_TEST_CASE( stake_negative, cyber_system_tester ) try {
   issue( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, cyber_system_tester ) try {
   issue( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
// Tests for voting
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, cyber_system_tester ) try {
   issue( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, cyber_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, cyber_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, cyber_system_tester ) try {
   issue( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.0000"), core_sym::from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_sym::from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, cyber_system_tester ) try {
   issue( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, cyber_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, cyber_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, cyber_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE(producer_pay, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...

   {
      ...
      BOOST_REQUIRE_EQUAL( error("missing authority of cyber"),
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_votepay_share, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_invariant, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_proxy, cyber_system_tester, * boost::unit_test::tolerance(1e-5)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_update_order, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, cyber_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_AUTO_TEST_CASE(votepay_transition2, * boost::unit_test::tolerance(1e-10)) try {
   cyber_system_tester t(cyber_system_tester::setup_level::minimal);
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, cyber_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, cyber_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, cyber_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, cyber_system_tester ) try {
   //accumulate proxied votes
   issue( "bob111111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("100.0002"), core_sym::from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, cyber_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, cyber_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, cyber_system_tester ) try {
   create_accounts_with_resources( {  N(defproducer1), N(defproducer2), N(defproducer3) } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer1", 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer2", 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer3", 3) );
   ...
   transfer(config::system_account_name, "alice1111111", core_sym::from_string("600000000.0000"));
...
BOOST_FIXTURE_TEST_CASE( buyname, cyber_system_tester ) try {
   ...
   transfer(config::system_account_name, "nofail", core_sym::from_string("1000.0000"));
...
BOOST_FIXTURE_TEST_CASE( bid_invalid_names, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, cyber_system_tester ) try {
   ...
   // alice outbids bob on prefb
   {
      ...
      BOOST_REQUIRE_EQUAL( initial_names_balance + core_sym::from_string("0.1001"), get_balance(config::names_account_name) );
   }
...
BOOST_FIXTURE_TEST_CASE( namebid_pending_winner, cyber_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_producers_in_and_out, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setparams, cyber_system_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
...
BOOST_FIXTURE_TEST_CASE( setram_effect, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, cyber_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( eosioram_ramusage, cyber_system_tester ) try {
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer(config::system_account_name, "alice1111111", core_sym::from_string("1000.0000"));
   BOOST_REQUIRE_EQUAL(success(), stake(config::system_account_name, "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000")));
   ...
   BOOST_REQUIRE_EQUAL( false, get_row_by_account( N(cyber.token), N(alice1111111), N(accounts), symbol{CORE_SYM}.to_symbol_code() ).empty() );

   //remove row
   base_tester::push_action( N(cyber.token), N(close), N(alice1111111), mvo()
                             ( "owner", "alice1111111" )
                             ( "symbol", symbol{CORE_SYM} )
   );
   BOOST_REQUIRE_EQUAL( true, get_row_by_account( N(cyber.token), N(alice1111111), N(accounts), symbol{CORE_SYM}.to_symbol_code() ).empty() );

   auto rlm = control->get_resource_limits_manager();
   auto eosioram_ram_usage = rlm.get_account_ram_usage(config::ram_account_name);
   auto alice_ram_usage = rlm.get_account_ram_usage(N(alice1111111));

   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111", 2048 ) );

   //make sure that ram was billed to alice, not to cyber.ram
   BOOST_REQUIRE_EQUAL( true, alice_ram_usage < rlm.get_account_ram_usage(N(alice1111111)) );
   BOOST_REQUIRE_EQUAL( eosioram_ram_usage, rlm.get_account_ram_usage(config::ram_account_name) );

} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( ram_gift, cyber_system_tester ) try {
   ...
   */
   ...
   BOOST_REQUIRE_EQUAL(success(), unstake(config::system_account_name, "alice1111111", core_sym::from_string("20.0000"), core_sym::from_string("10.0000")));
...
BOOST_FIXTURE_TEST_CASE( setabi_bios, TESTER ) try {
   ...
   create_account(N(cyber.token));
   set_abi( N(cyber.token), contracts::token_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(cyber.token) );
      _abi_hash abi_hash;
   ...
   set_abi( N(cyber.token), contracts::system_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(cyber.token) );
      _abi_hash abi_hash;
      auto abi_hash_var = abi_ser.binary_to_variant( "abi_hash", res, abi_serializer_max_time );
...
BOOST_FIXTURE_TEST_CASE( setabi, cyber_system_tester ) try {
   set_abi( N(cyber.token), contracts::token_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(cyber.token) );
      _abi_hash abi_hash;
