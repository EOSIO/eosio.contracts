...
BOOST_FIXTURE_TEST_CASE( create_tests, cyber_token_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("0.000 TKN"))
      ("max_supply", asset::from_string("1000.000 TKN"))
      ("issuer", "alice")
   );
   produce_blocks(1);
...
BOOST_FIXTURE_TEST_CASE( symbol_already_exists, cyber_token_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("0 TKN"))
      ("max_supply", asset::from_string("100 TKN"))
      ("issuer", "alice")
   );
   produce_blocks(1);
...
BOOST_FIXTURE_TEST_CASE( create_max_supply, cyber_token_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("0 TKN"))
      ("max_supply", asset::from_string("4611686018427387903 TKN"))
      ("issuer", "alice")
   );
   produce_blocks(1);
...
BOOST_FIXTURE_TEST_CASE( create_max_decimals, cyber_token_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("0.000000000000000000 TKN"))
      ("max_supply", asset::from_string("1.000000000000000000 TKN"))
      ("issuer", "alice")
   );
   produce_blocks(1);
...
BOOST_FIXTURE_TEST_CASE( issue_tests, cyber_token_tester ) try {
   ...
   auto stats = get_stats("3,TKN");
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("500.000 TKN"))
      ("max_supply", asset::from_string("1000.000 TKN"))
      ("issuer", "alice")
   );
   ...
   REQUIRE_MATCHING_OBJECT( alice_balance, mvo()
      ...
      ("payments", asset::from_string("0.000 TKN"))
   );
...
BOOST_FIXTURE_TEST_CASE( retire_tests, cyber_token_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( stats, mvo()
      ("supply", asset::from_string("300.000 TKN"))
      ("max_supply", asset::from_string("1000.000 TKN"))
      ("issuer", "alice")
   );
