...
BOOST_FIXTURE_TEST_CASE( wrap_exec_direct, eosio_wrap_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( fc::unsigned_int{0}, trace->action_traces[0].creator_action_ordinal );
   BOOST_REQUIRE_EQUAL( fc::unsigned_int{0}, trace->action_traces[0].closest_unnotified_ancestor_action_ordinal );
   BOOST_REQUIRE_EQUAL( "eosio.wrap", name{trace->action_traces[0].act.account} );
   ...
   BOOST_REQUIRE_EQUAL( "eosio.wrap", name{trace->action_traces[0].act.authorization[1].actor} );
   BOOST_REQUIRE_EQUAL( "active", name{trace->action_traces[0].act.authorization[1].permission} );

   BOOST_REQUIRE_EQUAL( fc::unsigned_int{1}, trace->action_traces[1].creator_action_ordinal );
   BOOST_REQUIRE_EQUAL( fc::unsigned_int{1}, trace->action_traces[1].closest_unnotified_ancestor_action_ordinal );
   BOOST_REQUIRE_EQUAL( "eosio", name{trace->action_traces[1].act.account} );
   BOOST_REQUIRE_EQUAL( "reqauth", name{trace->action_traces[1].act.name} );
   BOOST_REQUIRE_EQUAL( "bob", name{trace->action_traces[1].act.authorization[0].actor} );
   BOOST_REQUIRE_EQUAL( "active", name{trace->action_traces[1].act.authorization[0].permission} );
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( wrap_with_msig, eosio_wrap_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( fc::unsigned_int{0}, trace->action_traces[0].creator_action_ordinal );
   BOOST_REQUIRE_EQUAL( fc::unsigned_int{0}, trace->action_traces[0].closest_unnotified_ancestor_action_ordinal );
   BOOST_REQUIRE_EQUAL( "eosio.msig", name{trace->action_traces[0].act.account} );
   BOOST_REQUIRE_EQUAL( "exec", name{trace->action_traces[0].act.name} );
   BOOST_REQUIRE_EQUAL( "alice", name{trace->action_traces[0].act.authorization[0].actor} );
   BOOST_REQUIRE_EQUAL( "active", name{trace->action_traces[0].act.authorization[0].permission} );
} FC_LOG_AND_RETHROW()
