...
public:
   ...
   eosio_system_tester(Lambda setup) {
      ...
      set_code( N(eosio.token), read_wasm("../deps/eosio.token/bin/eosio.token/eosio.token.wasm") );
      set_abi( N(eosio.token), read_abi("../deps/eosio.token/bin/eosio.token/eosio.token.abi").data() ); 
      {
      ...
      set_code( config::system_account_name, read_wasm("../bin/eosio.system/eosio.system.wasm") );
      set_abi( config::system_account_name, read_abi("../bin/eosio.system/eosio.system.abi").data() );
