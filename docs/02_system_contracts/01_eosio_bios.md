## [eosio.bios system contract](action-reference/eosio.bios)
...
The actions implemented and publicly exposed by `eosio.bios` system contract are listed below and detailed in the [eosio.bios reference documentation](action-reference/eosio.bios).
