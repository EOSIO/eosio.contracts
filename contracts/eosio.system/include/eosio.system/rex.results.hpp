...
/**
 * \details The actions `buyresult`, `sellresult`, `rentresult`, and `orderresult` of `rex.results` are all no-ops.
...
class [[eosio::contract("rex.results")]] rex_results : eosio::contract {
   public:
      ...
      /**
       * \details Buyresult action.
       *
       * \param rex_received - amount of tokens used in buy order
       */
      [[eosio::action]] void buyresult( const asset& rex_received );

      /**
       * \details Sellresult action.
       *
       * \param proceeds - amount of tokens used in sell order
       */
      [[eosio::action]] void sellresult( const asset& proceeds );

      /**
       * \details Orderresult action.
       *
       * \param owner - the owner of the order
       * \param proceeds - amount of tokens used in order
       */
      [[eosio::action]] void orderresult( const name& owner, const asset& proceeds );

      /**
       * \details Rentresult action.
       *
