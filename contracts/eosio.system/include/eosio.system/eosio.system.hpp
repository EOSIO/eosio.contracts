   ...
   */
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         /// \details Returns the core symbol by system account name
         ...
         // Actions:
         /**
          * \details The Init action initializes the system contract for a version and a symbol.
          * Only succeeds when:
          * - version is 0 and
          * - symbol is found and
         ...
         /**
          * \details On block action. This special action is triggered when a block is applied by the given producer
         ...
         /**
          * \details Set account limits action sets the resource limits of an account
          *
          ...
          */
         [[eosio::action]] void setalimits(  const name& account, 
                                             int64_t ram_bytes, 
                                             int64_t net_weight, 
                                             int64_t cpu_weight );

         /**
          * \details Set account RAM limits action, which sets the RAM limits of an account
          *
          * \param account The name of the account whose resource limit to be set.
          * \param ram_bytes The ram limit in absolute bytes.
          */
         ...
         /**
          * \details Set account NET limits action, which sets the NET limits of an account
          *
          * \param account The name of the account whose resource limit to be set.
          * \param net_weight The fractionally proportionate net limit of available resources based on (weight / total_weight_of_all_accounts).
          */
         [[eosio::action]] void setacctnet(  const name& account, 
                                             const std::optional<int64_t>& net_weight );

         /**
          * \details Set account CPU limits action, which sets the CPU limits of an account
          *
          * \param account The name of the account whose resource limit to be set.
          * \param cpu_weight The fractionally proportionate cpu limit of available resources based on (weight / total_weight_of_all_accounts).
          */
         [[eosio::action]] void setacctcpu(  const name& account, 
         ...
         /**
          * \details Delegate bandwidth and/or cpu action. Stakes SYS from the balance of `from` for the benefit of `receiver`.
          *
          * \param from The account to delegate bandwidth from, that is, the account holding tokens to be staked.
          * \param receiver The account to delegate bandwith to, that is, the account to whose resources staked tokens are added.
          * \param stake_net_quantity The tokens staked for NET bandwidth.
          * \param stake_cpu_quantity The tokens staked for CPU bandwidth
          * \param transfer If true, ownership of staked tokens is transferred to `receiver`.
          *
          * \postconditions All producers `from` account has voted for will have their votes updated immediately.
          */
          ...
          * \param balance The amount to set the REX pool balance.
          */
         [[eosio::action]] void setrex( const asset& balance );

         /**
          * \details Deposit to REX fund action. Deposits core tokens to user REX fund.
          ...
          *
          * \param owner The REX fund owner account.
          ...
          *
          * \param from The owner account name.
          * \param amount Tne amount of tokens taken out of 'from' REX fund.
          *
          * \preconditions A voting requirement must be satisfied before action can be executed and
          * user must vote for at least 21 producers or delegate vote to proxy before buying REX.
          *
          * \postconditions User votes are updated following this action,
          * tokens used in purchase are added to user's voting power and
         ...
         /**
          * \details Unstaketorex action. Use staked core tokens to buy REX.
          * Storage change is billed to 'owner' account.
          *
          * \param owner The owner of staked tokens.
          * \param receiver The account name that tokens have previously been staked to.
          * \param from_net The amount of tokens to be unstaked from NET bandwidth and used for REX purchase.
          * \param from_cpu The amount of tokens to be unstaked from CPU bandwidth and used for REX purchase.
          *
          * \preconditions A voting requirement must be satisfied before action can be executed and 
          * user must vote for at least 21 producers or delegate vote to proxy before buying REX.
          *
          ...
          * bought REX cannot be sold before 4 days counting from end of day of purchase.
          */
         [[eosio::action]] void unstaketorex(   const name& owner, 
                                                const name& receiver, 
                                                const asset& from_net, 
                                                const asset& from_cpu );

         /**
          * \details Sellrex action. Sells REX in exchange for core tokens by converting REX stake back into core tokens
          ...
          *
          * \param from The owner account of REX.
          * \param rex The amount of REX to be sold.
          */
         [[eosio::action]] void sellrex( const name& from, const asset& rex );

         /**
          * \details Cnclrexorder action. Cancels unfilled REX sell order by owner if one exists.
          *
          * \param owner The owner account name.
          *
          * \preconditions Order cannot be cancelled once it's been filled.
          */
         [[eosio::action]] void cnclrexorder( const name& owner );

         /**
          * \details Rentcpu action. Use payment to rent as many SYS tokens as possible as determined by market price and
          ...
          *
          * \param from The account creating and paying for CPU loan, 'from' account can add tokens to loan
          *    balance using action `fundcpuloan` and withdraw from loan balance using `defcpuloan`.
          * \param receiver The account receiving rented CPU resources.
          * \param loan_payment The tokens paid for the loan, it has to be greater than zero,
          ...
          */
         [[eosio::action]] void rentcpu(  const name& from, 
                                          const name& receiver, 
                                          const asset& loan_payment, 
                                          const asset& loan_fund );

         /**
          * \details Rentnet action. Use payment to rent as many SYS tokens as possible as determined by market price and
          ...
          * All loan expenses and refunds come out of or are added to owner's REX fund.
          *
          * \param from The account creating and paying for NET loan, 'from' account can add tokens to loan
          *    balance using action `fundnetloan` and withdraw from loan balance using `defnetloan`.
          * \param receiver The account receiving rented NET resources.
          * \param loan_payment The tokens paid for the loan, it has to be greater than zero,
          *    amount of rented resources is calculated from `loan_payment`.
          * \param loan_fund - additional tokens can be zero, and is added to loan balance.
          *    Loan balance represents a reserve that is used at expiration for automatic loan renewal.
          */
         [[eosio::action]] void rentnet(  const name& from, 
                                          const name& receiver, 
                                          const asset& loan_payment, 
                                          const asset& loan_fund );

         /**
          * \details Fundcpuloan action. Transfers tokens from REX fund to the fund of a specific CPU loan in order to
          * be used for loan renewal at expiry.
          *
          * \param from The loan creator account.
          * \param loan_num The loan id.
          * \param payment The tokens transfered from REX fund to loan fund.
          */
         [[eosio::action]] void fundcpuloan( const name& from, 
                                             uint64_t loan_num, 
                                             const asset& payment );

         /**
          * \details Fundnetloan action. Transfers tokens from REX fund to the fund of a specific NET loan in order to
          * be used for loan renewal at expiry.
          *
          * \param from The loan creator account.
          * \param loan_num The loan id.
          * \param payment The tokens transfered from REX fund to loan fund.
          */
         [[eosio::action]] void fundnetloan( const name& from, 
                                             uint64_t loan_num, 
                                             const asset& payment );

         /**
          * \details Defcpuloan action. Withdraws tokens from the fund of a specific CPU loan and adds them to REX fund.
          *
          * \param from The loan creator account.
          * \param loan_num The loan id.
          * \param amount The tokens transfered from CPU loan fund to REX fund.
          */
         [[eosio::action]] void defcpuloan(  const name& from, 
                                             uint64_t loan_num, 
                                             const asset& amount );

         /**
          * \details Defnetloan action. Withdraws tokens from the fund of a specific NET loan and adds them to REX fund.
          *
          * \param from The loan creator account.
          * \param loan_num The loan id.
          * \param amount The tokens transfered from NET loan fund to REX fund.
          */
         [[eosio::action]] void defnetloan(  const name& from, 
                                             uint64_t loan_num, 
                                             const asset& amount );

         /**
          * \details Updaterex action. Updates REX owner vote weight to current value of held REX tokens.
          *
          * \param owner The REX owner account.
          */
         [[eosio::action]] void updaterex( const name& owner );

         /**
          * \details Rexexec action. Processes max CPU loans, max NET loans, and max queued sellrex orders.
          * Action does not execute anything related to a specific user.
          *
          * \param user The account that can execute this action,
          * \param max The number of each of CPU loans, NET loans, and sell orders to be processed.
          */
         [[eosio::action]] void rexexec( const name& user, uint16_t max );

         /**
          * \details Consolidate action. Consolidates REX maturity buckets into one bucket that can be sold after 4 days
          * starting from the end of the day.
          *
          * \param owner The REX owner account name.
          */
         [[eosio::action]] void consolidate( const name& owner );

         /**
          * \details Mvtosavings action. Moves a specified amount of REX into savings bucket. REX savings bucket
          ...
          *
          * \param owner The REX owner account name.
          * \param rex The amount of REX to be moved.
          */
         [[eosio::action]] void mvtosavings( const name& owner, const asset& rex );

         /**
          * \details Mvfrsavings action. Moves a specified amount of REX out of savings bucket. The moved amount
         ...
         /**
          * \details Closerex action. Deletes owner records from REX tables and frees used RAM. Owner must not have
          * an outstanding REX balance.
          *
          * \param owner The user account name.
          *
          * \preconditions If owner has a non-zero REX balance, the action fails; 
          *    otherwise, owner REX balance entry is deleted.
         ...
         /**
          * \details Undelegate bandwidth action. Decreases the total tokens delegated by `from` to `receiver` and/or
          ...
          * \param unstake_net_quantity The tokens to be unstaked from NET bandwidth.
          * \param unstake_cpu_quantity The tokens to be unstaked from CPU bandwidth.
          *
          * \postconditions Unstaked tokens are transferred to `from` liquid balance via a
         ...
         /**
          * \details Buy ram action. Increases receiver's ram quota based upon current price and quantity of
          ...
          */
         [[eosio::action]] void buyram(   const name& payer, 
                                          const name& receiver, 
                                          const asset& quant );

         /**
          * \details Buy a specific amount of ram bytes action. Increases receiver's ram in quantity of bytes provided.
          ...
          */
         [[eosio::action]] void buyrambytes( const name& payer, 
                                             const name& receiver, 
                                             uint32_t bytes );

         /**
          * \details Sell ram action. Reduces quota by bytes and then performs an inline transfer of tokens
         ...
         /**
          * \details Refund action. This action is called after the delegation-period to claim all pending
          ...
          * in producers tables.
          *
          * \param producer The account registering to be a producer candidate.
          ...
          * \param location The country code as defined in the ISO 3166, https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes
          *
          * \preconditions Producer to register is an account.
          * Authority of producer to register.
          */
         [[eosio::action]] void regproducer( const name& producer, 
         ...
         /**
          * \details Set ram action sets the ram supply.
          * \param max_ram_size The amount of ram supply to set.
          */
         [[eosio::action]] void setram( uint64_t max_ram_size );

         /**
          * \details Set ram rate action. Sets the rate of increase of RAM in bytes per block. It is capped by the uint16_t to
         ...
         /**
          * \details Vote producer action. Votes for a set of producers. This action updates the list of `producers` voted for,
          ...
          *
          * \preconditions Producers must be sorted from lowest to highest and must be registered and active.
          ...
          *
          * \postconditions Every producer previously voted for will have vote reduced by previous vote weight.
          ...
          */
         [[eosio::action]] void voteproducer(   const name& voter, 
                                                const name& proxy, 
                                                const std::vector<name>& producers );

         /**
          * \details Register proxy action. Set `proxy` account as proxy.
          ...
          *
          * \preconditions Proxy must have something staked (existing row in voters table)
          * New state must be different than current state
          */
         [[eosio::action]] void regproxy( const name& proxy, bool isproxy );

         /**
          * \details Set the blockchain parameters Set the blockchain parameters. By tunning these parameters a degree of
         ...
         /**
          * \details Claim rewards action. Claim block producing and vote rewards.
          * \param owner - producer account claiming per-block and per-vote rewards.
          */
         [[eosio::action]] void claimrewards( const name& owner );

         /**
          * \details Set privilege status for an account. Allows to set privilege status for an account (turn it on/off).
         ...
         /**
          * \details Remove producer action. Deactivates a producer by name, if not found asserts.
          * \param producer The producer account to deactivate.
          */
         [[eosio::action]] void rmvproducer( const name& producer );

         /**
          * \details Update revision action.  Updates the current revision.
          * \param revision - it has to be incremented by 1 compared with current revision.
          *
          * \preconditions Current revision can not be higher than 254, and has to be smaller
         ...
         /**
          * \details Bid name action. Allows an account `bidder` to place a bid for a name `newname`.
          ...
          *
          * \preconditions Bids can be placed only on top-level suffix.
          * Non empty name.
          ...
          */
         [[eosio::action]] void bidname(  const name& bidder, 
                                          const name& newname, 
                                          const asset& bid );

         /**
          * \details Bid refund action. Allows the account `bidder` to get back the amount it bid so far on a `newname` name.
          *
          ...
          */
         [[eosio::action]] void setinflation(   int64_t annual_rate, 
                                                int64_t inflation_pay_factor, 
                                                int64_t votepay_factor );
