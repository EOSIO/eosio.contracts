...
## cyber.system::cfgproducer    account config
...
## cyber.system::okproducer     account producer vote
...
## cyber.system::setproxy       account proxy
...
## cyber.system::unstake        account quantity 
...
## cyber.system::withdraw account
   - this action can only be triggered by cyber.system via a deferred transaction generated by unstake
   - this will generate an inline cyber.token::transfer call from=cyber.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## cyber.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## cyber.system::stakevote account amount
...
## cyber.system::onblock   account blocktime blocknum
...
## cyber.system::freeze producer accounts true|false 
...
## cyber.system::paystandby producer
