...
namespace eosiosystem {
   ...
   struct [[eosio::table, eosio::contract("cyber.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
    ...
    */
   struct [[eosio::table, eosio::contract("cyber.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("cyber.system")]] refund_request {
      name            owner;
